  ...
  return (
    <>
      ...
      {/* 
        ...
        ========================================
      */}
      <section className="py-16 bg-black border-b border-gray-800 relative overflow-hidden">
        {/* Background Accents */}
              ...
              <div className="lg:col-span-7 text-center lg:text-left space-y-8">
                  ...
                  <div className="pt-2 flex justify-center lg:justify-start">
                    <Button 
                      ...
                      variant="outline"
                      icon="fas fa-gamepad"
                      className="!bg-zinc-800/80 !border-gray-700 hover:!border-rivals-red hover:!bg-zinc-900 !ring-0 shadow-lg"
                    >
                      Scrim With Us
                    </Button>
                  </div>
